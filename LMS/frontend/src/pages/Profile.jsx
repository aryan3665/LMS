      ...
      <div className="bg-white shadow-lg rounded-2xl p-8 max-w-xl w-full relative">
        ...
        <div className="flex flex-col items-center text-center">
          {userData.photoUrl ? <img
            ...
            alt=""
            className="w-24 h-24 rounded-full object-cover border-4 border-[#7c2d4b]"
        ...
        <div className="mt-6 flex justify-center gap-4">
          <button className="px-5 py-2 rounded bg-[#44092d] text-white active:bg-[#065777] cursor-pointer transition" onClick={()=>navigate("/editprofile")}>
            Edit Profile
          </button>
